...
SESSION6 = os.environ.get("TERMUXSI")
sython6 = TelegramClient(StringSession(session2), APP_ID, APP_HASH)

session7 = os.environ.get("TERMUXSE")
SESSION7 = os.environ.get("TERMUXSE")
sython7 = TelegramClient(StringSession(session2), APP_ID, APP_HASH)

session8 = os.environ.get("TERMUXEI")
SESSION8 = os.environ.get("TERMUXEI")
sython8 = TelegramClient(StringSession(session2), APP_ID, APP_HASH)

session9 = os.environ.get("TERMUXNI")
SESSION9 = os.environ.get("TERMUXNI")
sython9 = TelegramClient(StringSession(session2), APP_ID, APP_HASH)

session10 = os.environ.get("TERMUXTE")
SESSION10 = os.environ.get("TERMUXTE")
sython10 = TelegramClient(StringSession(session2), APP_ID, APP_HASH)
